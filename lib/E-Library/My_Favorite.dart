          ...
          child: Column(children: [
            ...
            Expanded(
                child: ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: showFavoriteList['favorite'].length,
                            ...
                            InkWell(
                              onTap: () async{
                                bookInfo = await details(
                                    token,showFavoriteList['favorite'][index]['id']);
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl: 'http://10.0.2.2:8000/${showFavoriteList['favorite'][index]['image']}',
                                            ...
                                            Container(child: _star(
                                              double.parse(showFavoriteList['favorite'][index]['rate'].toString()),))
                                          ],
                                        ),
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            SizedBox(
                                              width: 207,
                                              child: Text(
                                                showFavoriteList['favorite'][index]['name'],
                                                style: const TextStyle(
                                                    fontSize: 20,
                                            ...
                                            SizedBox(
                                              width: 207,
                                              child: Text(
                                                showFavoriteList['favorite'][index]['author'],
                                                textAlign: TextAlign.center,
                                                style: const TextStyle(
                                                    fontSize: 15,
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    Text(
                                                      showFavoriteList['favorite'][index]['price'],
                                                      style: const TextStyle(
                                                          fontSize: 20,
                                                          fontWeight:
                                                          FontWeight.w800,
